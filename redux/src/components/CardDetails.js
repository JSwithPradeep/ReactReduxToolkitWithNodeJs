...
import { addToCart, emptycartIteam, removeSingleIteams, removeToCart} from '../redux/features/Cardslice'
...
const [totalquantity, setTotalQuantity] = useState(0);
  ...
  const handleDecrement = (e)=>{
    ...
    toast.success("Iteam Remove From Your Carts")
  ...
  const emptycarts =  ()=>{
    ...
    toast.success("Your All cards are empty")
  }

  //count total pricetotal
  const total = ()=>{
    let totalprice = 0
    carts.map((ele,ind)=>{
...
const countquantity = ()=>{
  ...
  const makePayment = async()=>{
    ...
    const res = await fetch ("http://localhost:7500/api/create-checkout-session",{
        method:"POST",
        headers:headers,
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right'>Total Price<span className='ml-2 mr-2'>:</span><span className='text-danger'>₹ {totalprice}</span></th>
                                                   <th className='text-right'><button className='bt btn-success' type='button' onClick={makePayment}>Checkout</button></th>
                                              </tr>
                                        </tfoot>
                                    </table>
                                }
